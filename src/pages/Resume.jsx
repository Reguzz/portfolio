...
const Resume = () => {
  ...
  const itemsSkills = t("Resume.skills.items");
  const itemsAboutme = t("Resume.info");
        ...
        >
          <TabsList className="flex flex-col w-full max-w-[380px] mx-auto xl:mx-0 gap-6">
            <TabsTrigger value="experience">
              {t("Resume.list.experience")}
            </TabsTrigger>
            <TabsTrigger value="education">
              {t("Resume.list.education")}
            </TabsTrigger>
            <TabsTrigger value="skills">{t("Resume.list.skills")}</TabsTrigger>
            <TabsTrigger value="aboutme">
              {t("Resume.list.aboutme")}
            </TabsTrigger>
          </TabsList>
